#if !defined(__GUI_config_output_h)
#define __GUI_config_output_h
/* ==================================================================== */
...
#pragma warning (disable:4530)
	...
	#define __EXPORT_OUTPUT __declspec(dllexport)
#else
	#define __EXPORT_OUTPUT __declspec(dllimport)
#endif
#else
	#define __EXPORT_OUTPUT
#endif
