...
void ReportView::print_formul(QString html)
{
    ...
    textprinter_->print(report_window1, tr("������ ���������"));
}
...
void ReportView::print_pdf_formul(QString html)
{
    ...
    QString filename;
        //fd = new QFileDialog;
        //filename = fd -> getSaveFileName(this, tr("���������"),"c:/test/test.pdf", tr("PDF (*.pdf)"));
    ...
    textprinter_->setOrientation(QPageLayout::Portrait);
    textprinter_->exportPdf(report_window1,"���������",filename);
}
