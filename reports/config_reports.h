#if !defined(__GUI_config_reports_h)
#define __GUI_config_reports_h
/* ==================================================================== */
...
#ifdef __USE_DLL_REPORTS

	#define __EXPORT_REPORTS __declspec(dllexport)
#else
	#define __EXPORT_REPORTS __declspec(dllimport)
#endif
#else
	#define __EXPORT_REPORTS
#endif
