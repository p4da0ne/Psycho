...
QMap<QString, QString> ReportData::pers_info(int id_object)
{
    ...
    query.next();
       ...
       pers_info_date->insert("3. rank_persones",query.value(rec.indexOf("rank_persones")).toString());
       pers_info_date->insert("4. contact_persones",query.value(rec.indexOf("contact_persones")).toString());
       pers_info_date->insert("5. description_persones",query.value(rec.indexOf("description_persones")).toString());
       pers_info_date->insert("6. authority_persones",query.value(rec.indexOf("authority_persones")).toString());
       pers_info_date->insert("7. opposition_persones",query.value(rec.indexOf("opposition_persones")).toString());
...
//        smi_info_date->insert(1,map);
        ...
        smi_info_date->insert(1,map);
        map.clear();
        map.insert("2. power_broadcast_smi",query.value(rec.indexOf("power_broadcast_smi")).toString());
        smi_info_date->insert(2,map);
        map.clear();
        map.insert("3. site_smi",query.value(rec.indexOf("site_smi")).toString());
        smi_info_date->insert(3,map);
        map.clear();
        map.insert("4. description_smi",query.value(rec.indexOf("description_smi")).toString());
        smi_info_date->insert(4,map);
        map.clear();
        map.insert("5. frequency_smi",query.value(rec.indexOf("frequency_smi")).toString());
        smi_info_date->insert(5,map);
        map.clear();
        map.insert("6. auditoria",query.value(rec.indexOf("auditoria")).toString());
        smi_info_date->insert(6,map);
        map.clear();
        map.insert("7. tirag",query.value(rec.indexOf("tirag")).toString());
        smi_info_date->insert(7,map);
        map.clear();
        map.insert("8. nametype_smi",query.value(rec.indexOf("nametype_smi")).toString());
        smi_info_date->insert(8,map);
        map.clear();
        map.insert("9. name_type_office_smi",query.value(rec.indexOf("name_type_office_smi")).toString());
        smi_info_date->insert(9,map);
        map.clear();
        map.insert("10. name_type_broadcast_smi",query.value(rec.indexOf("name_type_broadcast_smi")).toString());
        smi_info_date->insert(10,map);
        map.clear();
        map.insert("11. name_position_smi",query.value(rec.indexOf("name_position_smi")).toString());
        smi_info_date->insert(11,map);
        map.clear();
        map.insert("12. name_level_smi",query.value(rec.indexOf("name_level_smi")).toString());
        smi_info_date->insert(12,map);
        map.clear();
        map.insert("13. name_theme_smi",query.value(rec.indexOf("name_theme_smi")).toString());
...
QMap<int, QMap<QString, QString> > ReportData::ls_info(int id_object)
{
    ...
    query.next();
        ...
        map.clear();
        map.insert("2. name_region",query.value(rec.indexOf("name_region")).toString());
        ls_info_date->insert(2,map);
        map.clear();
        map.insert("3. enimy_ls",query.value(rec.indexOf("enimy_ls")).toString());
        ls_info_date->insert(3,map);
        map.clear();
        map.insert("4. mpo_ls",query.value(rec.indexOf("mpo_ls")).toString());
        ls_info_date->insert(4,map);
        map.clear();
        map.insert("5. counte_ls",query.value(rec.indexOf("counte_ls")).toString());
        ls_info_date->insert(5,map);
        map.clear();
        map.insert("6. counte_ls_bd",query.value(rec.indexOf("counte_ls_bd")).toString());
        ls_info_date->insert(6,map);
        map.clear();
        map.insert("7. mps_priz_ls",query.value(rec.indexOf("mps_priz_ls")).toString());
        ls_info_date->insert(7,map);
        map.clear();
        map.insert("8. mps_konrt_ls",query.value(rec.indexOf("mps_konrt_ls")).toString());
        ls_info_date->insert(8,map);
        map.clear();
        map.insert("9. mps_of_ls",query.value(rec.indexOf("mps_of_ls")).toString());
        ls_info_date->insert(9,map);
        map.clear();
        map.insert("10. short_name_ls",query.value(rec.indexOf("short_name_ls")).toString());
