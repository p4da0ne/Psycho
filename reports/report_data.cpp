...
QMap<QString, QString> ReportData::pers_info(int id_object)
{
    ...
    foto_name = get_pers_foto_from_DB(id_object);
       ...
       pers_info_date->insert("1. Фотография:","<CENTER><IMG BORDER=\"0\" SRC=\""+foto_name+"\" width = 200 height=200> </CENTER>");
       ...
       pers_info_date->insert("8. Тип персоналии",query.value(rec.indexOf("name_type_persones")).toString());
