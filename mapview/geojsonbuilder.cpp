...
GeojsonBuilder::GeojsonBuilder(QObject *parent)
    : QObject{parent}
{}

QJsonObject GeojsonBuilder::createProperties(SignData& sign){
...
QJsonObject GeojsonBuilder::createGeometry(SignData& sign){
