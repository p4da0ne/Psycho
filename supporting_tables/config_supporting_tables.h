#if !defined(__GUI_config_supporting_tables_h)
#define __GUI_config_supporting_tables_h
/* ==================================================================== */
...
#pragma warning (disable:4530)
	...
	#define __EXPORT_SUPPORTING_TABLES __declspec(dllexport)
#else
	#define __EXPORT_SUPPORTING_TABLES __declspec(dllimport)
#endif
#else
	#define __EXPORT_SUPPORTING_TABLES
#endif
