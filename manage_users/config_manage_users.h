#if !defined(__GUI_config_manage_users_h)
#define __GUI_config_manage_users_h
/* ==================================================================== */
...
#pragma warning (disable:4530)
	...
	#define __EXPORT_MANAGE_USERS __declspec(dllexport)
#else
	#define __EXPORT_MANAGE_USERS __declspec(dllimport)
#endif
#else
	#define __EXPORT_MANAGE_USERS
#endif
