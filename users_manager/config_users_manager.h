#if !defined(__GUI_config_users_manager_h)
#define __GUI_config_users_manager_h
/* ==================================================================== */
...
#ifdef __USE_DLL_USERS_MANAGER

	#define __EXPORT_USERS_MANAGER __declspec(dllexport)
#else
	#define __EXPORT_USERS_MANAGER __declspec(dllimport)
#endif
#else
	#define __EXPORT_USERS_MANAGER
#endif
