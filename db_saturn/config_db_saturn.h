#if !defined(__GUI_config_db_saturn_h)
#define __GUI_config_db_saturn_h
/* ==================================================================== */
...
#pragma warning (disable:4530)
	...
	#define __EXPORT_DB_SATURN __declspec(dllexport)
#else
	#define __EXPORT_DB_SATURN __declspec(dllimport)
#endif
#else
	#define __EXPORT_DB_SATURN
#endif
